...
namespace Megatech.FMS.Web
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        internal void DeleteAsync(Task<ApplicationUser> u)
        {
    ...
    {
        public IdentityRoleManager(IRoleStore<IdentityRole, string> store) : base(store)
        {
        }
        public static IdentityRoleManager Create(IdentityFactoryOptions<IdentityRoleManager> options, IOwinContext context)
        {
            var appRoleManager = new IdentityRoleManager(new RoleStore<IdentityRole>(context.Get<ApplicationDbContext>()));
