...
namespace Megatech.FMS.Web
{
    ...
    public static class XMLtoDataTable
    {
        ...
        public static DataSet ImportExcelXML(string fileName, bool hasHeaders, int ignoreRows, bool autoDetectColumnType)
        {
            StreamReader sr = new StreamReader(fileName);
            Stream st = (Stream)sr.BaseStream;
            return ImportExcelXML(st, hasHeaders, ignoreRows, autoDetectColumnType);
        }

        private static DataSet ImportExcelXML(Stream inputFileStream, bool hasHeaders, int ignoreRows, bool autoDetectColumnType)
        {
